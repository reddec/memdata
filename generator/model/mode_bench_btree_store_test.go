...
func (tree *BTree) Put(key int64, value *User) {
...
// Key should adhere to the comparator's type assertion, otherwise method panics.
func (tree *BTree) Get(key int64) (value *User, found bool) {
...
// Key should adhere to the comparator's type assertion, otherwise method panics.
func (tree *BTree) Remove(key int64) {
	node, index, found := tree.searchRecursively(tree.Root, key)
	if found {
...
func (tree *BTree) LeftValue() (result *User) {
	if left := tree.Left(); left != nil {
...
func (tree *BTree) RightValue() (result *User) {
	if right := tree.Right(); right != nil {
...
func (tree *BTree) search(node *BTreeNode, key int64) (index int, found bool) {
...
func (tree *BTree) searchRecursively(startNode *BTreeNode, key int64) (node *BTreeNode, index int, found bool) {
	if tree.Empty() {
		return nil, -1, false
	}
	node = startNode
...
func (tree *BTree) leftSibling(node *BTreeNode, key int64) (*BTreeNode, int) {
	if node.Parent != nil {
...
// key is any of keys in node (could even be deleted).
func (tree *BTree) rightSibling(node *BTreeNode, key int64) (*BTreeNode, int) {
	if node.Parent != nil {
		index, _ := tree.search(node.Parent, key)
		index++
...
func (tree *BTree) rebalance(node *BTreeNode, deletedKey int64) {
...
func (tree *BTree) Iterator() BTreeIterator {
	return BTreeIterator{tree: tree, node: nil, position: 0}
}
...
func (iterator *BTreeIterator) Value() *User {
	return iterator.entry.Value
}

// Key returns the current element's key.
// Does not modify the state of the iterator.
func (iterator *BTreeIterator) Key() int64 {
	return iterator.entry.Key
}

// Begin resets the iterator to its initial state (one-before-first)
// Call Next() to fetch the first element if any.
func (iterator *BTreeIterator) Begin() {
	iterator.node = nil
	iterator.position = 0
	iterator.entry = nil
}
...
func (iterator *BTreeIterator) End() {
	iterator.node = nil
	iterator.position = 2
	iterator.entry = nil
}
...
// Modifies the state of the iterator
func (iterator *BTreeIterator) First() bool {
	iterator.Begin()
...
// Modifies the state of the iterator.
func (iterator *BTreeIterator) Last() bool {
	iterator.End()
